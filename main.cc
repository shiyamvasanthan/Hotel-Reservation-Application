...
int testResOverlap(){
    ...
    //1st additional test: Testing different months that should overlap
    Date date9(2023, 10, 31);
    Date date10(2023, 11, 3);
    Reservation r11("Joe", date9, 4);
    Reservation r12("Joe", date10, 3);

    std::cout<<endl;
    if (!resOverlap(r11, r12, true)) score = 0;

    //2nd additional test: Testing different months that should not overlap
    Date date11(2022, 10, 31);
    Date date12(2022, 11, 3);
    Reservation r13("Joe", date11, 3);
    Reservation r14("Joe", date12, 3);

    std::cout<<endl;
    if (!resOverlap(r13, r14, false)) score = 0;

    //3rd additional test: Testing different years with the same month and day that should not overlap
    Date date13(2021, 7, 6);
    Date date14(2024, 7, 6);
    Reservation r15("Joe", date13, 5);
    Reservation r16("Joe", date14, 5);

    std::cout<<endl;
    if (!resOverlap(r15, r16, false)) score = 0;

    //4th additional test: Testing different years that should overlap
    Date date15(2022, 12, 31);
    Date date16(2023, 1, 6);
    Reservation r17("Joe", date15, 7);
    Reservation r18("Joe", date16, 5);
